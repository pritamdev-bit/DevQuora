        ...
        <form className="space-y-4 w-full" onSubmit={submit}>
            ...
            <LabelInputContainer>
                ...
                <div className="flex w-full gap-4">
                    ...
                    <button
                        className="relative shrink-0 rounded-full border border-slate-600 bg-slate-700 px-8 py-2 text-sm text-white transition duration-200 hover:shadow-2xl hover:shadow-white/[0.1] hover:ring-2 hover:ring-blue-600"
                        type="button"
                        onClick={() => {
            ...
            <button
                className="inline-flex h-12 animate-shimmer items-center justify-center rounded-md border border-slate-800 bg-[linear-gradient(110deg,#000103,45%,#1e2631,55%,#000103)] bg-[length:200%_100%] px-6 font-medium text-slate-400 transition-colors focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50 hover:ring-blue-600 hover:ring-2"
                type="submit"
                disabled={loading}
            >
