...
const Notification = ({ user }: { user: Models.User<UserPrefs> }) => {
    return (
        <figure
            className={cn(
                "relative mx-auto min-h-fit w-full lg:max-w-[400px] transform cursor-pointer overflow-hidden rounded-2xl p-4",
                // animation styles
...
export default async function TopContributers() {
    ...
    return (
        <div className=" relative flex max-h-[400px] min-h-[400px] w-full lg:max-w-[32rem] flex-col overflow-hidden rounded-lg bg-white/10 p-6 shadow-lg">
            <AnimatedList>
